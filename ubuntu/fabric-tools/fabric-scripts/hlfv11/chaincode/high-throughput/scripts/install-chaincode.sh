...
peer chaincode install -n composerchannel -v $1 -p /opt/gopath/src/github.com/hyperledger/fabric/examples/chaincode/go
...
peer chaincode install -n composerchannel -v $1 -p github.com/hyperledger/fabric/examples/chaincode/go
